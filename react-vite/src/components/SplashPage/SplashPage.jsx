          ...
          {arr.map((song) => (
            <div key={song.id} className="song-cont ">
              <div
                ...
                style={{
                  backgroundImage: `url(${song.image_file})`,
                  width: "170px",
                  height: "170px",
                }}
                ...
                {currUser && (
                  <div className="liked-song-info-cont column">
                    <div className="heart-title-cont-splash row">
                      <div
                        className="heart-cont-splash click"
                        onClick={(e) => {
                          handelLiked(e, song);
                        }}
                      >
                        <i className="fa-solid fa-heart splash-heart"></i>
                      </div>
                    </div>
                  </div>
                )}
      ...
      {showPopup && toggleSong && (
        <div className="splash-added">
          ...
          <div id="toggle-bttm">
            ...
            <span>
              was added to your <NavLink to="/songs/current">Library</NavLink>
            </span>
          </div>
        </div>
      )}
