    ...
    return(
        <div id='user-profile-main-cont'>
            ...
            <div id='user-pic-cont'>
                ...
                : <img className='profile-img' src='https://static-00.iconduck.com/assets.00/profile-default-icon-2048x2045-u3j7s5nj.png'/>
                }
            </div>
            <div id='user-name-cont'>
                <div id='user-page-name'><span>{user.username}</span></div>
